...
void initializeOptionsFromCommandLine( int argc, char **argv, SimulationOptions & simulationOptions )
{
	...
	opts.addOption("-randomSeed", &simulationOptions.globalOptions._random_seed, OPTION_DATA_TYPE_UNSIGNED_INT);
	opts.addOption("-saveTraces", NULL, OPTION_DATA_TYPE_NO_DATA, 0, &simulationOptions.globalOptions.saveTraces, true);
	opts.addOption("-tracesFileName", &simulationOptions.globalOptions.tracesFileName, OPTION_DATA_TYPE_STRING);
	opts.addOption("-tracesStepSize", &simulationOptions.globalOptions.traceStepSize, OPTION_DATA_TYPE_FLOAT);
...
/*
void initializeOptions(SimulationOptions & simulationOptions)
{
	//
	// BEFORE PARSING NORMAL COMMAND LINE: check for special-case command-line options.
	//
