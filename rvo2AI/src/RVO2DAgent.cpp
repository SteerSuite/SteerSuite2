...
void RVO2DAgent::computeNeighbors()
{
	...
	float rangeSq = _RVO2DParams.rvo_time_horizon_obstacles * _RVO2DParams.rvo_time_horizon_obstacles;
	...
	if (_RVO2DParams.rvo_max_neighbors > 0)
	{
		...
		while ( agentNeighbors_.size() > _RVO2DParams.rvo_max_neighbors )
		{
			agentNeighbors_.pop_back();
		}
		// dynamic_cast<RVO2DAIModule *>(rvoModule)->kdTree_->computeAgentNeighbors(this, rangeSq);
...
/*
	...
	/*if ( _gEngine->isAgentSelected(this) )
	{
		DrawLib::drawFlag( this->_currentLocalTarget, gBlue, 2.0 );
	}*/
...
void RVO2DAgent::runLongTermPlanningAStarLite()
{
...
void RVO2DAgent::runMidTermPlanningAStarLite()
{
...
void RVO2DAgent::FindAndSetFurthestVisibleLocalTarget()
{
