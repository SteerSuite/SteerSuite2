...
protected:
	...
	void runLongTermPlanningAStarLite();
	void runMidTermPlanningAStarLite();
	bool _reachedCurrentGoal();
	bool _reachedCurrentWaypoint();
	bool _reachedLocalTarget();
	bool _LocalTargetIsFinalGoal();
	void FindAndSetFurthestVisibleLocalTarget();
