...
namespace Util {
	...
	/*
	const static Vector North(0.0, 0.0, 1.0);
	const static Vector South(0.0f, 0.0f, -1.0f);
	const static Vector West(1.0f, 0.0f, 0.0f);
	const static Vector East(-1.0f, 0.0f, 0.0f);
	*/
