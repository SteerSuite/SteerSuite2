...
void Camera::apply()
{
	...
	//glLoadIdentity();
	DrawLib::setGLViewMatrix(m_currentView.position.x, m_currentView.position.y, m_currentView.position.z,
...
void Camera::apply_stereo(bool right)
{
	...
	DrawLib::setGLViewMatrix(position.x, position.y, position.z,
