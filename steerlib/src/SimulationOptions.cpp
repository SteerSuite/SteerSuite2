...
// GUI ACTIONS
#define DEFAULT_KEY_QUIT                  GLFW_KEY_ESCAPE
...
#define DEFAULT_BACKGROUND_COLOR  Color(0.8f, 0.8f, 0.8f) // seems useless right now
#define DEFAULT_OBSTACLE_COLOUR  Color(0.8f, 0.8f, 0.95f)
...
#define DEFAULT_MAX_ITEMS_PER_GRID_CELL 15
...
SimulationOptions::SimulationOptions()
{
	...
	globalOptions._random_seed = 2891;
	...
	guiOptions.obstacleColor  = DEFAULT_OBSTACLE_COLOUR;
...
void SimulationOptions::_setupXMLStructure( Util::XMLParser & xmlOpts )
{
	...
	guiTag->createChildTag("obstacleColor", "The default colour of obstacle in the openGL visualization", XML_DATA_TYPE_RGB, &guiOptions.obstacleColor);
